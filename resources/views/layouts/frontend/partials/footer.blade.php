@php
    $categories = \App\Category::latest()->take(8)->get();
@endphp
            ...
            <div class="col-lg-4 col-md-6">
                <div class="footer-section">
                    ...
                    <a class="logo" href="{{ route('home') }}"><img
                            src="{{asset('public/assets/frontend/logo/logo.png')}}" alt="Logo Image"></a>
                ...
                <div class="footer-section">
                    ...
                    <ul>
                        @foreach($categories as $key => $value)
                            <li><a href="{{ route('category.post', $value->slug) }}">{{ $value->name }}</a></li>
                        @endforeach
                    </ul>
                </div><!-- footer-section -->
            </div><!-- col-lg-4 col-md-6 -->
